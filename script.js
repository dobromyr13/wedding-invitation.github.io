...
const CHAT_ID = atob("LTEwMDI1NjE4NzQ2OTc=");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  async function sendToTelegram(message) {
    const WEB_APP_URL =
      "https://script.google.com/macros/s/AKfycbxLCfxNqhQJrLUxZlrSfiRjV61C5HCoiMm5RaurwcRd0cRPM8taMk-EvH2LT_BNsaMY/exec"; // Вставьте свой URL
